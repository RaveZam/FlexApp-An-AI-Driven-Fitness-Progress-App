            ...
            {dailyVolume.map((d, i) => {
              ...
              return (
                <View key={d.day} style={styles.barCol}>
                  ...
                  >
                    {isRest ? (
                      <View style={{ flex: 1, backgroundColor: p.hairlineStrong }} />
                    ) : (
                      <LinearGradient
                        colors={
                          isToday
                            ? [p.accent, p.accentDeep]
                            : [p.accent, p.accentBorder]
                        }
                        start={{ x: 0, y: 0 }}
                        end={{ x: 0, y: 1 }}
                        style={{ flex: 1 }}
                  ...
                  <Text
                    style={[
                      styles.barLabel,
                      { color: isToday ? p.accent : p.mutedSoft },
                    ]}
                  >
                    {d.day.slice(0, 1)}
                  </Text>
  ...
  return (
    <View style={styles.stat}>
      ...
      <View style={styles.statValueRow}>
        <Text style={[styles.statValue, accent && { color: p.accent }]}>{value}</Text>
